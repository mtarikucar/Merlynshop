...
function ContactUs() {
    return (
        <section class="bg-white  py-6 border ">
            <div class="container px-6 py-12 mx-auto">
                <div class="text-center">
                    <p class="font-medium text-green-500 text-2xl">Contact us</p>
                ...
                <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                    <div class="flex flex-col items-center justify-center text-center">
                        <span class="p-3 text-green-500 rounded-full bg-green-100/80 ">
                        ...
                        <p class="mt-2 text-green-500 "> nurlightllc@gmail.com</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <p class="mt-2 text-green-500 ">16200 Livingston Rd Accokeek, MD 20607 United States</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <p class="mt-2 text-green-500 ">+1 (555) 000-0000</p>
                    </div>
                </div>
            </div>
        </section>
