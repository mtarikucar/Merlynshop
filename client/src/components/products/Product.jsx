...
function Product({ product }) {
  ...
  return (
    <>
      ...
      <div className="relative m-4  overflow-hidden rounded-lg bg-white shadow-md">
        ...
        <span className="absolute top-0 left-0 w-28 translate-y-2 -translate-x-8 -rotate-45 bg-rose-500 text-center text-sm text-white">İndirim</span>
        <div className="mt-4 px-5 pb-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="flex items-center rounded-md bg-green-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-blue-300">
