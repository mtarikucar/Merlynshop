        ...
        <section className="bg-white  py-6 border ">
            <div className="container px-6 py-12 mx-auto">
                <div className="text-center">
                    <p className="font-medium text-green-500 text-2xl">Contact us</p>
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-2 text-green-500 "> nurlightllc@gmail.com</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-2 text-green-500 ">16200 Livingston Rd Accokeek, MD 20607 United States</p>
                    </div>
