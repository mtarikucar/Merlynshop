...
function Footer() {
  return (
    <footer
      aria-label="Site Footer h-full"
      className="bg-white border-2 border-green-500 mx-1 rounded-lg"
    >
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="max-w-xs mt-4 text-gray-500">
              ...
              Facebook, LetGo, Sahibinden, Dolap, Gardrops gibi sayfalara
              yükleyerek satışını gerçekleştiriyorsunuz. Satışı gerçekleşen
              ürünün 'Sipariş Oluştur' kısmında kargo kodu ve diğer bilgilerini
              girerek, panelden sipariş oluşturuyorsunuz. Oluşturduğunuz
              siparişi sizin adınıza biz gönderiyoruz ve ödemesi sizin
              hesabınıza geliyor. Ödemeyi aldıktan sonra bize ödemesini
            ...
            <ul className="flex gap-6 mt-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-700 transition hover:text-green-400"
                >
              ...
              <nav aria-label="Footer Navigation-Legal " className="mt-6">
                <ul className="space-y-4   text-sm">
                  ...
                  <li className="flex gap-2 items-center">
                    ...
                    />
                    <p className="text-gray-700 transition ">+90 5060687100</p>
                  </li>
                </ul>
              </nav>
            </div>
