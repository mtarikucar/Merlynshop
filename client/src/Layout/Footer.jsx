...
function Footer() {
  return (
    <footer
      ...
      className="bg-white border-2 border-green-500 mx-1 rounded-lg my-2 "
    >
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="max-w-xs mt-4 text-gray-500">
              Stoksuz, Sermayesiz ve Ön Ödemesiz ! Siz de ürünlerimizi dijital platformlardan ve çevrenizdeki insanlara satarak para kazanabilirsiniz
            </p>
