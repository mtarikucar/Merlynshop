                ...
                <form  className=' space-y-5'  action="" onSubmit={formik.handleSubmit}>
                    <div>
                        <div className="relative mt-2 w-full">
                            ...
                            <label htmlhtmlhtmlFor="username" className="origin-[0] peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-green-600 absolute left-1 top-2 z-10 -translate-y-4 scale-75 transform cursor-text select-none bg-white px-2 text-sm text-gray-500 duration-300"> Enter Your User Name </label>
                        </div>
                    </div>
                    <div>
                        <div className="relative mt-2 w-full">
