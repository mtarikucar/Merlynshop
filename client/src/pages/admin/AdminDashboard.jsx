                        ...
                        <div className="grid grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                            ...
                            <div className="col-span-12">
                                <div className="grid gap-2">
                                    <div className="m-3 overflow-hidden  w-full text-xl text-gray-900 font-semibold  ">
                                        ...
                                        <div
                                            className='flex sm:flex-row space-y-2 sm:space-x-2 flex-col w-full items-center justify-center p-3'>
