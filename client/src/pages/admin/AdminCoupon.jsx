...
function AdminCoupon() {
    ...
    const { data: coupons, isLoading, isError } = useQuery(["coupons"], fetchSliders);
                                        ...
                                        <div class="flex w-full max-w-full flex-col break-words rounded-lg border border-gray-100 bg-white text-gray-600 shadow-lg">
                                            <div class="p-3 flex  justify-between">
                                                ...
                                                <div class="pt-1">
                                                    ...
                                                    <h4 class="text-2xl font-semibold tracking-tighter xl:text-2xl">₺{coupon.discountAmount}</h4>
                                                </div>
                                                <div class="pt-1">
                                                    <p class="text-sm font-light capitalize ">Min Tutar</p>
                                                    <h4 class="text-2xl font-semibold tracking-tighter xl:text-2xl">₺{coupon.minOrderAmount}</h4>
                                                </div>
                                            ...
                                            <div class="py-2 px-3  flex justify-between items-center">
                                                ...
                                                <p class="font-light"><span class="text-md font-bold text-slate-600-600">#{coupon.code} </span></p>
                                                <button
