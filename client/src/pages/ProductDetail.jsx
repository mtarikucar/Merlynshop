                    ...
                    <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                        ...
                        <div className="sm:order-1 mt-10">
                            <div className="flex h-8  text-gray-600">
                                <button
                                    onClick={() => hundleDecreaseCart(data)}
                                ...
                                <button
                                    onClick={() => hundleIncreaseCart(data)}
                        ...
                        <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                            ...
                            <button
                                ...
                                type="button" className="inline-flex items-center justify-center rounded-md border-2 border-transparent bg-green-500 bg-none px-12 py-3 text-center text-base font-bold text-white hover:border-green-500 hover:text-green-500 transition-all duration-200 ease-in-out focus:shadow hover:bg-white">
