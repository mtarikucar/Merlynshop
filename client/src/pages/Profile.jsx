...
function Profile() {
    ...
    useEffect(() => {
        ...
        setCreatedAt(givenDate.getDate() + '/' + (givenDate.getMonth() + 1) + '/' + givenDate.getFullYear())
    }, [])
    ...
    return (
        ...
        <div className='grid grid-cols-12 w-full h-full p-6'>
            <div className='col-span-4  h-full sticky top-0 '>
             
                    <div class="m-10 max-w-sm h-full">
                        <div class="rounded-lg border bg-white px-4 pt-8 pb-10 shadow-lg">
                            <div class="relative mx-auto w-36 rounded-full">
                                <img class="mx-auto h-auto w-full rounded-full" src="https://therminic2018.eu/wp-content/uploads/2018/07/dummy-avatar.jpg" alt="" />
                            </div>
                            ...
                            <ul class="mt-3 divide-y rounded bg-gray-100 py-2 px-3 text-gray-600 shadow-sm hover:text-gray-700 hover:shadow">
                                <li class="flex items-center py-3 text-sm">
                                    <span>Status</span>
                                    <span class="ml-auto"><span class="rounded-full bg-green-200 py-1 px-2 text-xs font-medium text-green-700">{user.role}</span></span>
                                </li>
                                <li class="flex items-center py-3 text-sm">
                                    <span>Joined On</span>
            ...
            <div className='col-span-8  mx-5 my-10 max-h-[60vh] overflow-y-scroll scrollbar scrollbar-thumb-green-400 scrollbar-track-gray-100  overflow-hidden'>
                <div className='grid grid-cols-3 gap-3 p-3'>
                    <a href="" className="group relative block h-64 sm:h-80 lg:h-96">
                        ...
                        >
                            <div
                                className="p-4 !pt-0 transition-opacity text-3xl group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8"
                            >
                               <LocalShippingIcon fontSize='large'/>

                                <h2 className="mt-4 text-xl font-medium sm:text-2xl">Order : </h2>
                            </div>
